...
/* ===================================================== */
    ...
    whatsappLink.href =
        `chat.html?adId=${item.id}&sellerId=${sellerId}`;
...
async function loadFurniture() {
    try {
        ...
        const snapshot = await getDocs(furnitureQuery);
        ...
        snapshot.forEach((docSnapshot) => {
            ...
            furnitureList.appendChild(buildFurnitureCard(data));
        });

    } catch (error) {
        console.error("Error loading furniture:", error);
        loadingMessage.textContent = "Unable to load furniture. Please try again later.";
    }
}
