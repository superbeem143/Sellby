...
if (publishBtn) {
    publishBtn.addEventListener("click", async () => {
        ...
        const title = getFieldValue("productName");
        ...
        if (selectedFiles.length === 0 || !title || !price) {
            alert(t('identity_required') || "1 Photo + Price + Product Name required.");
            return;
        }
        ...
        try {
            ...
            const docData = {
                ...
                productName: title,
                brand,
                electronicsCategory: getFieldValue("category"),
                condition: getFieldValue("condition"),
                warranty: getFieldValue("warranty"),
                price: Number(price),
                location,
                description,
                imageUrls,
            ...
            alert("Success: Your electronics ad is now live!");
            ...
            publishBtn.textContent = "Publish Electronics";
        }
    });
}
...
if (saveDraftBtn) {
    saveDraftBtn.addEventListener("click", () => {
        ...
        localStorage.setItem("electronics_ad_draft", JSON.stringify(draft));
        alert("Electronics draft saved locally!");
    });
}
