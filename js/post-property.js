...
function renderPreview() {
    ...
    // Append Add Image Tile if under MAX_IMAGES
    ...
    publishBtn.addEventListener("click", async () => {
        ...
        try {
            ...
            const docData = {
                ...
                title,
                price: Number(price),
                pricePerSqYard: getFieldValue("pricePerSqYard"),
                layoutName: getFieldValue("layoutName"),
                type: getFieldValue("type"),
                totalArea: getFieldValue("totalArea"),
                facing: getFieldValue("facing"),
                location,
                description,
                imageUrls,
                status: "published",
            ...
            publishBtn.textContent = "Preview Ad";
        }
    });
}
...
if (saveDraftBtn) {
    saveDraftBtn.addEventListener("click", () => {
        ...
        localStorage.setItem("property_ad_draft", JSON.stringify(draft));
